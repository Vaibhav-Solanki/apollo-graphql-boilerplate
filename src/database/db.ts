...
const composeEntityModelFilename = (entity:string):string => `./models/${entity}`
const composeEntityRepoFilename = (entity:string):string => `./repository/${entity}`

const modelMap = new Map()
const repoMap = new Map()

export const getModel = (entity: string) => {
...
export const getRepo = async (entityName: string) => {
